//reference:
//https://github.com/cinight/ShadersForFun/tree/master

Shader "Unlit/StereogramShader"
{
	Properties
    {
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _PatternTex, _PatternTex2, _MainTex, _DepthTex;
			float _DepthContrast, _DepthFactor, _ScrollingSpeed;
			int _CurrentStrip, _NumOfStrips;
